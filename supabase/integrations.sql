...
values 
  ...
  ('google-calendar', 'Google Calendar', 'Manage your calendar events.', 'oauth2'),
  ('google-forms', 'Google Forms', 'Manage and view form responses.', 'oauth2'),
  ('youtube', 'YouTube', 'Manage your YouTube channel and videos.', 'oauth2'),
  ('google-maps', 'Google Maps', 'Use Maps and Geocoding services.', 'api_key'),
  ('google-gemini', 'Google Gemini', 'Use the latest Gemini AI models.', 'api_key'),
  ('airtable', 'Airtable', 'Connect your Airtable bases.', 'oauth2'),
  ('hubspot', 'HubSpot', 'Connect your HubSpot CRM.', 'oauth2'),
  ('calendly', 'Calendly', 'Manage your Calendly meetings.', 'oauth2'),
  ('dropbox', 'Dropbox', 'Manage your Dropbox files.', 'oauth2'),
  ('webhook', 'Webhooks', 'Send and receive generic webhooks.', 'api_key'),
  ('acuity', 'Acuity Scheduling', 'Manage your Acuity appointments.', 'oauth2'),
  ('database', 'Direct Database', 'Connect to external databases.', 'api_key'),
  ('facebook-leads', 'Facebook Lead Ads', 'Receive leads from Facebook Ads.', 'oauth2'),
  ('instagram', 'Instagram', 'Manage your Instagram profile.', 'oauth2'),
  ('jotform', 'Jotform', 'Manage your Jotform forms.', 'oauth2'),
  ('linkedin', 'LinkedIn', 'Manage your LinkedIn profile.', 'oauth2'),
  ('microsoft-excel', 'Microsoft Excel', 'Read and write rows in Excel Online.', 'oauth2'),
  ('onedrive', 'OneDrive', 'Manage your OneDrive files.', 'oauth2'),
  ('opentable', 'OpenTable', 'Manage your restaurant bookings.', 'oauth2'),
  ('outlook', 'Outlook', 'Manage your Outlook emails and calendar.', 'oauth2'),
  ('paypal', 'PayPal', 'Manage your PayPal transactions.', 'oauth2'),
  ('pipedrive', 'Pipedrive', 'Connect your Pipedrive CRM.', 'oauth2'),
  ('quickbooks', 'QuickBooks', 'Manage your QuickBooks accounting.', 'oauth2'),
  ('salesforce', 'Salesforce', 'Connect your Salesforce CRM.', 'oauth2'),
  ('servicetitan', 'ServiceTitan', 'Connect your ServiceTitan account.', 'oauth2'),
  ('shopify', 'Shopify', 'Manage your Shopify store.', 'oauth2'),
  ('square', 'Square', 'Manage your Square payments.', 'oauth2'),
  ('toast-pos', 'Toast POS', 'Manage your Toast POS system.', 'oauth2'),
  ('typeform', 'Typeform', 'Manage your Typeform forms.', 'oauth2'),
  ('whatsapp', 'WhatsApp', 'Send WhatsApp messages.', 'oauth2'),
  ('woocommerce', 'WooCommerce', 'Manage your WooCommerce store.', 'oauth2'),
  ('zillow', 'Zillow', 'Manage your real estate listings.', 'oauth2')
